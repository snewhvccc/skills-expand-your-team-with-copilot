...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced').
      Use 'All' to only return activities with no specified difficulty (i.e. suitable for all levels)
    """
    ...
    if difficulty:
        ...
        if normalized_difficulty == "all":
            # "All" means activities with no specified difficulty (suitable for every level)
